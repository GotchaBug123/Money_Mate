...
public class FeaturePageController {
    ...
    @Operation(
            summary = "커뮤니티 메인 화면",
            description = "커뮤니티 메인 화면으로 이동합니다."
    )
    ...
    @Operation(
            summary = "커뮤니티 게시글 목록 화면",
            description = "커뮤니티 게시글 목록 화면으로 이동합니다."
    )
    ...
    @Operation(
            summary = "커뮤니티 게시글 상세 화면",
            description = "특정 게시글 상세 화면으로 이동합니다."
    )
    ...
    @Operation(
            summary = "커뮤니티 게시글 작성 화면",
            description = "게시글 작성 화면으로 이동합니다."
    )
    ...
    @Operation(
            summary = "내 게시글 화면",
            description = "로그인 사용자의 게시글 목록 화면으로 이동합니다."
    )
    ...
    @Operation(
            summary = "커뮤니티 게시글 수정 화면",
            description = "특정 게시글 수정 화면으로 이동합니다."
    )
    ...
    @Operation(
            summary = "댓글 등록 화면 처리",
            description = "화면 Form 요청으로 게시글 댓글을 등록한 뒤 게시글 상세 화면으로 이동합니다."
    )
