...
const PortfolioAuto = () => {
    ...
    const handleResult = () => {
        navigate('/portfolio/result', {
            state: { stocks, investAmount: amount, currency, startDate, endDate, goalAmount, typeName, totalScore, selectedThemes, productScores },
        });
    };
                ...
                <div className={styles.resultSection}>
                    {!loading && !stocks && (
                        <div className={styles.emptyState}>
                            ...
                            <p className={styles.emptyTitle}>투자 정보를 입력하면<br/>추천 포트폴리오가 표시됩니다</p>
                            <p className={styles.emptyDesc}>AI가 성향에 맞는 최적의 종목을 구성해드려요.</p>
                        </div>
                    )}
